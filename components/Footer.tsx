    ...
    <footer className="bg-bg-canvas border-t border-border-subtle pt-16 pb-24 lg:pb-8 mt-20 transition-colors duration-300 print:hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-text-secondary leading-relaxed max-w-xs">
                Water Resources Engineer with a focus on GIS and web development.
              </p>
            </div>
          ...
          {/* Column 2: Sections */}
          <div>
            <h4 className="text-xs font-bold text-text-primary uppercase tracking-[0.2em] mb-6">Sections</h4>
            <ul className="space-y-4">
              ...
              <li><a href="#experience" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Experience</a></li>
              <li><a href="#blog" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Blog</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><a href="#skills" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Skills</a></li>
              <li><a href="#certifications" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Certifications</a></li>
              <li><a href="#publications" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Publications</a></li>
              <li><a href="#resume" className="text-sm text-text-secondary hover:text-brand-accent transition-colors">Resume</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-6">
            <div>
              <h4 className="text-xs font-bold text-text-primary uppercase tracking-[0.2em] mb-6">Contact</h4>
