    ...
    >
      ...
      <div className="relative bg-slate-50 rounded-lg shadow-sm p-6 border border-slate-200">
        ...
        <div className="absolute top-6 h-0 w-0 
                        ...
                        border-r-8 border-r-slate-50
                        -left-2">
        </div>

        <p className="text-sm font-medium text-cyan-600 mb-1">{item.period}</p>
        <h3 className="mb-2 font-bold text-slate-800 text-lg">{item.role}</h3>
        <p className="text-md leading-snug tracking-wide text-slate-600 mb-4">{item.company}</p>
        
        <div className="text-sm text-slate-600 space-y-2 mb-4">
            <h4 className="font-semibold text-slate-700">Responsibilities:</h4>
